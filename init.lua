...
-- " numbering: vim.cmd("set nonumber")
...
--  map	<F7>  gT<C-w>W
vim.api.nvim_set_keymap("n", "<F7>", "gT<C-w>W", {})
-- imap	<F7>  <Esc>gT<C-w>W
vim.api.nvim_set_keymap("i", "<F7>", "<Esc>gT<C-w>W", {})

--  map	<F8>  gt<C-w><C-w>
vim.api.nvim_set_keymap("n", "<F8>", "gt<C-w><C-w>", {})
-- imap	<F8>  <Esc>gt<C-w><C-w>
vim.api.nvim_set_keymap("i", "<F8>", "<Esc>gt<C-w><C-w>", {})

--  map 	<F9>  :x<CR>
vim.api.nvim_set_keymap("n", "<F9>", ":x<CR>", {})
-- imap 	<F9>  <Esc>:x<CR>
vim.api.nvim_set_keymap("i", "<F9>", "<Esc>:x<CR>", {})

--  map	<F10> :xa<CR>
vim.api.nvim_set_keymap("n", "<F10>", ":xa<CR>", {})
-- imap	<F10> <Esc>:xa<CR>
vim.api.nvim_set_keymap("i", "<F10>", "<Esc>:xa<CR>", {})

--  map	<F4>  :qa!<CR>
vim.api.nvim_set_keymap("n", "<F4>", ":qa!", {})
-- imap	<F4>  <Esc>:qa!<CR>
vim.api.nvim_set_keymap("i", "<F4>", "<Esc>:qa!", {})

--  map	<F5>  :wa!<CR>
vim.api.nvim_set_keymap("n", "<F5>", ":wa!<CR>", {})
-- imap	<F5>  <Esc>:wa!<CR>
vim.api.nvim_set_keymap("i", "<F5>", "<Esc>:wa!<CR>", {})
...
vim.opt.guicursor = 'a:hor20-blinkwait0-blinkoff10-blinkon10'
